...
The first numerical method is based on a finite difference discretization of the domain and it is suitable for *more general tumbling kernels*. The second method is based on a spectral discretization, it is more efficient and it is an *Asymptotic Preserving scheme*.
